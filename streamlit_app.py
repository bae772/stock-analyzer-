...
for idx, ticker in enumerate(tickers):
    ...
    try:
        ...
        # ── 기간별 등락률 계산
        pct_changes = {}
        for period_name, days_back in [("1일",1),("1주",5),("1개월",22),("3달",66),("6달",132),("1년",252)]:
            if len(close) > days_back:
                pct = round((last_close - close.iloc[-days_back])/close.iloc[-days_back]*100,2)
