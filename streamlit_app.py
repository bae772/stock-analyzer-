...
for idx, ticker in enumerate(tickers):
    ...
    try:
        ...
        try:
            ...
            # 3개월
            three_months = last_date - BDay(66)  # 약 3개월 영업일 기준
            if three_months in close.index:
                pct_changes['3달'] = round((last_close - close.loc[three_months])/close.loc[three_months]*100,2)
        except:
            st.warning(f"{ticker}: 기간별 퍼센트 계산 오류")
